...
export function OfferSteps() {
  return (
    <section aria-labelledby="offer-steps-heading" className="page-section">
      <div className="site-shell">
        <div className="rounded-3xl border border-clay-border bg-clay px-6 py-10 text-dark sm:px-10">
