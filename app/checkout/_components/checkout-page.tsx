...
export function CheckoutPage() {
  ...
  if (!isReady) {
    return <div className="site-shell py-12" aria-busy="true"><div className="h-96 animate-pulse rounded-3xl bg-white" /></div>;
  }

  if (order) {
    return (
      <div className="site-shell flex min-h-[65vh] items-center justify-center py-12">
  ...
  if (items.length === 0) {
    return <div className="site-shell py-12"><div className="rounded-3xl border border-border bg-white"><CartEmpty /></div></div>;
  }
